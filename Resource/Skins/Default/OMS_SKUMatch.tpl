    ...
    <article class="container-fluid">
        <header>
            <div class="btn-group btn-group-sm pull-right">
                <button class="btn btn-success btn-batch" data-toggle="modal" data-target="#batch-panel" disabled><span class="glyphicon glyphicon-indent-left"></span> 批量操作</button>
                <button class="btn btn-success btn-upload" data-toggle="modal" data-target="#modal-upload"><span class="glyphicon glyphicon-upload"></span> 上传SPU</button>
        ...
        <table id="data-list" class="table table-hover table-bordered table-striped table-condensed">
            <caption>销售SKU</caption>
            <thead>
                <tr>
                    <th><label id="select-all"><input type="checkbox"> 数据编号</label></th>
                    <th>CustomLabel (上架SKU)</th>
                    <th>备注</th>
                    <th>操作</th>
                </tr>
            </thead>
            <tbody>
				<!-- BEGIN 数据列表 ATTRIB= -->
				<tr data-id="{DataID}">
                    <td><label><input type="checkbox"> {DataID}</label></td>
					<td>{Name}</td>
					<td>{Remark}</td>
                    <td>
