        ...
        <div class="row">
            <div class="col-sm-6">
                <div id="data-list" class="panel panel-default mg-b-0">
                    <div class="panel-heading">出库单列表</div>
            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading"><button class="btn btn-success btn-xs btn-submit" type="button">出库复核提交</button><b class="text-danger pull-right"><span class="glyphicon glyphicon-star"></span>请确认输入法处于英文状态下！</b></div>
                    <div class="panel-body">
    ...
    <script>
        (function () {
            ...
            $('.btn-submit').on('click', function() {
                common.ajax({
                    title: '出库复核',
                    URL: '/Logistics/Logistics.aspx?Do=OutStock',
                    type: 'post',
                    data: {
                        InsideOrder: $txt.val()
                    },
