        ...
        <table id="data-list" class="table table-hover table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                <tr data-id="{DataID}">
                    ...
                    <td>{WID}</td>
                    <td>{Code}</td>
                    <td><a href="Rack.aspx?WID={WID}&FID={DataID}">{Name}</a></td>
                    <td>{Status}</td>
                    <td>{Date}</td>
                    <td>
    ...
    <div id="add-data" class="modal fade" tabIndex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form  class="form-horizontal" method="post" action="?Do=Save&WID={WID}">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        <h4 class="modal-title">[{仓库名称}] 进行库区设置</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">库区编号</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="DataID" ID="DataID" placeholder="库区编号，系统自动分配" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">库区编码</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="Code" ID="Code" placeholder="库区编码，系统自动分配" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">库区名称</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="Name" ID="Name" placeholder="库区的命名，中文">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">库区状态</label>
                            <div class="col-sm-10">
