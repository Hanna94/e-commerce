                            ...
                            <!-- 售后设置 -->
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group form-group-sm">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="" class="form-control" placeholder="额外退款的说明，额外退款时必填">
                                                            </div>
                                                        </div>
                                                        <div class="form-group form-group-sm">
                                                            <label class="control-label col-sm-3">GBP</label>
                                                            <div class="col-sm-9">
                                                                <div class="input-group">
                                                                    <input id="set-status" type="text" class="form-control" placeholder="金额">
                                                                    <span class="input-group-btn">
                                                                        <button class="btn btn-default btn-sm" type="button">申请</button>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-sm-12 bd-t pd-t-5">
                                        <button class="btn btn-default btn-sm center-block" type="button">保存</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
//=========================================== 模态框方法 ====================================================
            ...
            (function() {
                ...
                var tableHTML = $('<div class="row"><div class="col-sm-12 maxH200"><table id="order-list" class="table table-striped table-bordered table-hover table-condensed"></table></div></div>');
                tableHTML.find('table').html('<thead>'
                                + '<th>订单号</th>'
                                + '<th>账号</th>'
                                + '<th>产品</th>'
                                + '<th>金额</th>'
                ...
                $('#btn-search').on('click', function() {
                    ...
                    $.ajax({
                        ...
                        success : function(d) {
                            ...
                            tableHTML.find('tbody').html(Mustache.render(template, d));
                            $search.after(tableHTML);
                ...
                // 隐藏&显示订单列表
                $('#search-list-toggle').on('click');
            })(); // 搜索交易单 - End

            // 选择后获取订单信息并遍历
            function SelectBtn() {
                $('#order-list').on('click', '.selected', function() {
